...
export default function Banner() {
  return (
    <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
      ...
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-rose-300 to-emerald-300 opacity-30"
          style={{
            clipPath:
      ...
      >
        <div
          className="aspect-[577/310] w-[36.0625rem] bg-gradient-to-r from-yellow-200 to-green-300 opacity-30"
          style={{
            clipPath:
              'polygon(74.8% 41.9%, 97.2% 73.2%, 100% 34.9%, 92.5% 0.4%, 87.5% 0%, 75% 28.6%, 58.5% 54.6%, 50.1% 56.8%, 46.9% 44%, 48.3% 17.4%, 24.7% 53.9%, 0% 27.9%, 11.9% 74.2%, 24.9% 54.1%, 68.6% 100%, 74.8% 41.9%)',
          }}
      ...
      <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
        <p className="text-sm leading-6 text-gray-900">
          ...
          Did you know we also do pet sitting?
        </p>
        <a
          href="#"
